...
export default function ContinueWatching() {
    ...
    const mockCourses: Course[] = [
        { id: 'course-001', classificationId: 'class-01', name: 'React 마스터 클래스', description: 'React의 모든 것을 마스터합니다.', thumbnailUrl: 'https://picsum.photos/seed/101/600/400', thumbnailHint: 'code laptop' },
        { id: 'course-003', classificationId: 'class-03', name: '매일 30분 요가', description: '하루 30분으로 몸과 마음의 균형을 찾으세요.', thumbnailUrl: 'https://picsum.photos/seed/103/600/400', thumbnailHint: 'yoga mat' },
        { id: 'course-007', classificationId: 'class-05', name: '비즈니스 영어 회화', description: '실전 비즈니스 상황에서 자신있게 소통하는 법을 배웁니다.', thumbnailUrl: 'https://picsum.photos/seed/107/600/400', thumbnailHint: 'business meeting' },
        { id: 'course-009', classificationId: 'class-01', name: 'Node.js 백엔드 개발', description: 'JavaScript로 확장 가능한 서버를 구축합니다.', thumbnailUrl: 'https://picsum.photos/seed/109/600/400', thumbnailHint: 'server code' },
    ];
