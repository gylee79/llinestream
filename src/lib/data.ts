...
export const users: User[] = [
  {
    ...
    dob: '1990-01-01',
    activeSubscriptions: {
      'class-001': { expiresAt: new Date(new Date().setDate(new Date().getDate() + 25)) }
    },
  ...
  },
  {
    ...
    dob: '1985-05-10',
    activeSubscriptions: {
      'class-001': { expiresAt: new Date(new Date().setDate(new Date().getDate() + 365)) },
      'class-002': { expiresAt: new Date(new Date().setDate(new Date().getDate() + 365)) },
      'class-003': { expiresAt: new Date(new Date().setDate(new Date().getDate() + 365)) },
    },
...
// Helper to get data, simulating API calls
